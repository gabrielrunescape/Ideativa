...
export const IdeaHeader = () => {
    ...
    return (
        <header>
            <nav className="flex items-center justify-between h-[56px] font-medium xs:mx-5 sm:mx-4 lg:mx-auto md:max-w-[769px] lg:max-w-[1152px] xl:max-w-[1344px]">
                <Link href="/" className="flex flex-col items-center gap-1">
                    <img src={logo} className="w-[89px]" alt="Ideativa Logo" />
                </Link>
                ...
                <ul className="hidden sm:flex gap-6 items-center text-sm transition-all has-text-link">
                ...
                <div className={`absolute z-10 top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-[95%]': 'w-0'}`}>
                    <div className="flex border-l flex-col text-gray-600">
