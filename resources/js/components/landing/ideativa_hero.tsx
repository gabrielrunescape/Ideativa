import {Box, Button, Card, Columns, Container, Heading, Hero } from 'react-bulma-components';
                ...
                <Container>
                    <Columns>
                        <Columns.Column>
                            ...
                            <Heading size={1}textTransform="uppercase">
                        ...
                        <Columns.Column>
                            <Columns py={3} backgroundColor="warning" className="button-div-1307">
                                ...
                                <Columns.Column textAlign="left" style={{width: 63.11}}>
                            ...
                            <Columns py={3} backgroundColor="link" className="button-div-1319">
                                <Columns.Column size={4}>
                                    <div className="graph">
